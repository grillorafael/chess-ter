...
Evaluator.pawnTable = 
	...
	Evaluator.kingTableEndGamePhase = 
	[
...
Evaluator.evaluateBoardscore = function(board) 
{
	...
	if (Evaluator.blackPawnCount[1] >= 1 && Evaluator.blackPawnCount[0] == 0 && Evaluator.blackPawnCount[2] == 0)
	{
	 	score += 14;
	}

	if (Evaluator.blackPawnCount[2] >= 1 && Evaluator.blackPawnCount[1] == 0 && Evaluator.blackPawnCount[3] == 0)
	{
	 	score += 16;
	}

	if (Evaluator.blackPawnCount[3] >= 1 && Evaluator.blackPawnCount[2] == 0 && Evaluator.blackPawnCount[4] == 0)
	{
	 	score += 20;
	}

	if (Evaluator.blackPawnCount[4] >= 1 && Evaluator.blackPawnCount[3] == 0 && Evaluator.blackPawnCount[5] == 0)
	{
	 	score += 20;
	}

	if (Evaluator.blackPawnCount[5] >= 1 && Evaluator.blackPawnCount[4] == 0 && Evaluator.blackPawnCount[6] == 0)
	{
	 	score += 16;
	}

	if (Evaluator.blackPawnCount[6] >= 1 && Evaluator.blackPawnCount[5] == 0 && Evaluator.blackPawnCount[7] == 0)
	{
	 	score += 14;
	}
	...
	if (Evaluator.whitePawnCount[1] >= 1 && Evaluator.whitePawnCount[0] == 0 && Evaluator.whitePawnCount[2] == 0)
	{
	 	score -= 14;
	}

	if (Evaluator.whitePawnCount[2] >= 1 && Evaluator.whitePawnCount[1] == 0 && Evaluator.whitePawnCount[3] == 0)
	{
		score -= 16;
	}

	if (Evaluator.whitePawnCount[3] >= 1 && Evaluator.whitePawnCount[2] == 0 && Evaluator.whitePawnCount[4] == 0)
	{
	 	score -= 20;
	}

	if (Evaluator.whitePawnCount[4] >= 1 && Evaluator.whitePawnCount[3] == 0 && Evaluator.whitePawnCount[5] == 0)
	{
	 	score -= 20;
	}

	if (Evaluator.whitePawnCount[5] >= 1 && Evaluator.whitePawnCount[4] == 0 && Evaluator.whitePawnCount[6] == 0)
	{
	 	score -= 16;
	}

	if (Evaluator.whitePawnCount[6] >= 1 && Evaluator.whitePawnCount[5] == 0 && Evaluator.whitePawnCount[7] == 0)
	{
	 	score -= 14;
	}
